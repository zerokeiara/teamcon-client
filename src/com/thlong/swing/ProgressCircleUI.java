...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/thlong/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/thlong/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/thlong/icon/file.png")).getImage();
    }
