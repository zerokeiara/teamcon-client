...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new com.thlong.swing.ImageAvatar();
        txt = new com.thlong.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/thlong/icon/testing/dog.jpg"))); // NOI18N
    ...
    private com.thlong.swing.ImageAvatar IaImage;
    private javax.swing.JLayeredPane jLayeredPane1;
    private com.thlong.component.Chat_Item txt;
