...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/thlong/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/thlong/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.thlong.swing.JIMSendTextPane();
    ...
    private com.thlong.swing.JIMSendTextPane txt;
